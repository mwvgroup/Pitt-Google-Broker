...
Messages successfully published to PS topic `ztf_alert_data` (blue); failed messages
...
- \[left\] Messages successfully published to PS topic `ztf_alert_avro_bucket` (blue;
