...
class ZTFCandidate(_base):
    ...
    pid = Column(types.Float, nullable=False)
    ...
    objectidps1 = Column(types.Float)
    ...
    objectidps2 = Column(types.Float)
    ...
    objectidps3 = Column(types.Float)
    ...
    rfid = Column(types.Float, nullable=False)
