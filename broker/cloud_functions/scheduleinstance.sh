...
gcloud compute instances create-with-container consume-ztf-1 --zone=us-central1-a --machine-type=f1-micro --image-project=cos-cloud --container-image=gcr.io/ardent-cycling-243415/consume_ztf:22384b3d3855fe23cf0584e966df13fe38c2b544 --labels=env=consume-ztf-1 --image=cos-stable-81-12871-1185-0

gcloud compute instances create-with-container consume-ztf-2 --zone=us-central1-a --machine-type=f1-micro --image-project=cos-cloud --container-image=gcr.io/ardent-cycling-243415/consume_ztf:22384b3d3855fe23cf0584e966df13fe38c2b544 --labels=env=consume-ztf-2 --image=cos-stable-81-12871-1185-0
