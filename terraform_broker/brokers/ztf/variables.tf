variable "alerts_schema_version" {
  description = "BigQuery schema version to use for the ZTF alerts table."
  type = string
  default = "4.02"
  nullable = false
}
...
variable "consumer_use_authentication" {
  description = "Set the consumer VM to use authentication."
  type = boolean
  default = false
  nullable = false
}
